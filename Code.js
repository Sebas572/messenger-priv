        ...
        if (document.getElementById(x) !== null){
            ...
            Imagenes = addFotos.split(x+":");
                if(Imagenes[1] !== undefined){
                    ...
                    if (Preg1[1] == undefined){
                        document.getElementById("Contactos").innerHTML = "<div class='ContenedoresDeMensajes' id='"+x+"' onclick=Actualizar('"+(x)+"')><table><tr><td style='width: 100%;'><IMG class='fotos' src='"+colocarIMG+"'><center><font>"+x+"</font><br><font id='"+x+"Mensaje'>"+z+""+y+"</font></center></td><td style='display: block;'></IMG><IMG src='ore-vertical.svg' width='30' class='more' onclick=SeguroQueQuieresEliminarElChat('"+(x)+"')></IMG></td></tr></table></div><hr>"+document.getElementById("Contactos").innerHTML;
                    }else if (Preg1[1] == undefined){
